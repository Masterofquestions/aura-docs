...
description: "How to write YES/NO prediction markets that resolve cleanly: unambiguous questions, authoritative sources, and rules that cover the edge cases."
---
...
>
> **Decision window:** Any time during 2025, using the official sources below.
>
...
### Define when the answer is decidable

- State the event and timeframe in the question or rules, rather than relying
  on a platform expiry.
- Explain which source and condition make the answer decidable.
