...
Aura's dispute system rewards voters who back the correct outcome, and it funds
those rewards through **slashing** rather than by skimming USDT fees. The result
is strictly aligned: the wrong side of a controversial market literally funds
the right side.
...
Because the pool is denominated in $AURA, dispute voters earn $AURA, giving a
