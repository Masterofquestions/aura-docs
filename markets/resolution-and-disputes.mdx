...
(**YES** or **NO** — `TOO_EARLY` is a dispute-vote option, not a
...
Both the proposer and the disputer have funds at stake — the loser's bond
...
the full loser bond would make a self-dispute — propose from one wallet,
dispute from another — free, enabling risk-free griefing of voters.)
...
- Your staked balance is **snapshotted when you commit** — unstaking
...
the slashing economics — a voter risks real $AURA to push a wrong outcome.
...
opens. Only then does the round counter advance — sitting out the reveal
