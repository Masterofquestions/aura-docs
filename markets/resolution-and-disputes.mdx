...
- **Trading continues uninterrupted.** Nothing is cancelled, no positions are
  ...
  where they were.
- **Trading fees stay with the market.** They keep accruing and are only paid
  out to the creator, treasury, and referrers once the market eventually
  resolves YES or NO.
...
- You must hold a vaulted $AURA position above the **None** tier (i.e. at
  least the **Iron** tier, 60,000 $AURA) at commit time.
- Your staked balance is **snapshotted when you commit**, so unstaking
  between commit and reveal doesn't dodge the slashing risk.
...
Dispute rewards are paid in **$AURA**, so the wrong side of a controversial
market literally funds the right side. See
