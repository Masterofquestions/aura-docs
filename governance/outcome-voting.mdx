...
<Steps>
  ...
  <Step title="Reveal happens automatically">
    ...
    manually via `POST /v1/tx/oracle/reveal`, but don't miss the
    window.)
  </Step>
...
| `TOO_EARLY` | The event hasn't happened yet, the data source isn't out, or the question is malformed. If this wins, the submitted outcome is thrown out and the market returns to trading. Nothing is cancelled or refunded. |
