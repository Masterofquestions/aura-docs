...
empowering users to predict future events across diverse categories including
real-world occurrences, sports, elections, and crypto market movements. Aura
leverages a robust, transparent, and scalable system designed to reward accurate
predictions, incentivize market creation, and encourage active community
governance.
...
<CardGroup cols={2}>
  <Card title="Create Your Account" icon="wallet" href="/getting-started/connecting">
    Sign up with email or Google. The wallet is built in.
  </Card>
  <Card title="Deposit Funds" icon="money-bill-transfer" href="/getting-started/bridging">
    Fund your USD balance from Ethereum, Base, Arbitrum, BNB Chain, or a card.
  </Card>
