...
service's OpenAPI 3.1 spec, so it cannot drift from the implementation.

<CardGroup cols={2}>
  <Card title="Authentication" icon="key" href="/api-reference/authentication">
    Wallet-bound sessions via a signed challenge. No API keys.
  </Card>
  <Card title="Rate limits" icon="gauge-high" href="/api-reference/rate-limits">
    Anonymous + signed-in tiers, IETF `RateLimit-*` headers.
  </Card>
