...
The published spec covers the integrator surface. Endpoints used only by the Aura
app itself are omitted, so if you find a reference to something absent from the
spec, it isn't a public interface.
