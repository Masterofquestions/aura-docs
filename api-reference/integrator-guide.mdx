...
```bash
curl -N "https://api.aurabets.io/v1/realtime/stream?topics=market:3abc...:orders,market:3abc...:fills"
```
...
The spec at [`/openapi.json`](https://api.aurabets.io/openapi.json) is OpenAPI
...
npx @openapitools/openapi-generator-cli generate \
  -i https://api.aurabets.io/openapi.json \
  -g python \
  -o ./aura-client
```
