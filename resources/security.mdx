...
These describe the current pre-mainnet source, including automatic daily fee
distribution and its recorded payment safeguards. Operational enforcement,
infrastructure, production credentials and live recovery remain launch
qualifications; local verification does not imply a live production app,
user population or funds.
