...
Liquidity rewards do **not** wait for market resolution. They are scored per
day for next-day delivery once allocation and payment evidence are complete.
The separate [creator reward schedule](/programs/creator-rewards) also supports
daily payouts before resolution.
