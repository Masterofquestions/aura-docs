...
Referral fees accrue from settled fills as your referrals trade, then enter the
automatic payout queue for delivery to your wallet. A payment can remain pending
until the worker and chain confirmation complete; it does not wait for the
market to resolve.
...
<Note>
Payout timing follows settled fills and payout processing, not a market's
resolution. Your dashboard shows pending and paid history so you can distinguish
an accrued referral amount from a confirmed wallet payment.
</Note>
