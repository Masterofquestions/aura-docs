...
<CardGroup cols={2}>
  <Card title="Recorded settlement and reward epochs" icon="flag-checkered">
    Referral and dispute payments follow their recorded settlement paths.
    Creator rewards use recorded Router epochs, accepted components and exact
    residuals. Aura sends eligible payouts automatically; an escrow handoff or
    pending history entry is not a confirmed wallet payment.
  </Card>
